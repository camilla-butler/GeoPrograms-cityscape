public class B4_MiltonFilter extends World
{
   ...
   public void go()
   {
      plane.loadBackGround("squiddy.png");          //*** new method to load a diffrent JPG
      System.out.println("This will be printed to the  window. ");
      plane.teleport(0,0);
      plane.showBackGround();                    
      System.out.println(plane.howMuchRed());         
   
      for(int row=220; row<300; row++)    //*** this is using new getBackground
      {
         for(int col=570; col<730; col++)    //*** this is using new getBackgroun
         {
            ...
            if(red>255 && green >255 && blue>255) //&&green<240 && blue< 100)
            {
               plane.setPixelColor(255,10,10);
            }
